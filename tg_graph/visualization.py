...
def visualize_graph_html(
    ...
    parts = [
        ...
        "<script>if(typeof d3===\"undefined\"){document.body.innerHTML='<p style=\"color:red\">Не удалось загрузить d3.js. Проверьте подключение к интернету.</p>';}</script>",
        "<style>",
        "body {font-family: Arial, sans-serif;}#graph{will-change:transform;}",
